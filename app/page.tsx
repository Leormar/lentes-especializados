    ...
    <section className="py-16 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10">
          ...
          <div className="w-16 h-1 bg-[#0ea5e9] mx-auto mb-6 rounded-full" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
          <div className="space-y-3">
            <p className="font-semibold text-[#0c4a6e] text-lg mb-4">Nuestras especialidades:</p>
            {[
          ...
          <div className="bg-[#f0f9ff] rounded-2xl p-8 border border-sky-100 flex flex-col justify-center">
            <p className="text-[#0ea5e9] font-semibold text-sm uppercase tracking-widest mb-4">El equipo</p>
            {[
              ...
              <div key={p.nombre} className="py-3 border-b border-sky-100 last:border-0">
                <p className="font-semibold text-[#0c4a6e] text-sm">{p.nombre}</p>
                <p className="text-slate-500 text-xs mt-0.5">{p.rol}</p>
              </div>
            ))}
            <Link
              href="/quienes-somos"
              className="mt-5 text-center border-2 border-[#0c4a6e] text-[#0c4a6e] px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-[#0c4a6e] hover:text-white transition-colors"
            >
  ...
  const valores = [
    {
      icono: (
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
          ...
          <path d="M12 20l6 6 10-12" stroke="#0c4a6e" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      ),
      titulo: "Calidad",
    ...
    },
    {
      icono: (
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
          <circle cx="20" cy="20" r="18" stroke="#0ea5e9" strokeWidth="2" />
          <path d="M20 10v10l6 4" stroke="#0c4a6e" strokeWidth="2.5" strokeLinecap="round" />
        </svg>
      ),
      titulo: "Experiencia",
    ...
    },
    {
      icono: (
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
          <circle cx="20" cy="20" r="18" stroke="#0ea5e9" strokeWidth="2" />
          <path d="M14 26c0-4 3-8 6-10M26 14c-1.5 4-4 7-6 9" stroke="#0c4a6e" strokeWidth="2.5" strokeLinecap="round" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {valores.map((v) => (
            <div
              key={v.titulo}
              className="bg-white rounded-2xl p-8 text-center border border-sky-100 shadow-sm hover:shadow-md hover:border-[#0ea5e9] transition-all"
            >
              <div className="flex justify-center mb-5">{v.icono}</div>
              <h3 className="text-xl font-bold text-[#0c4a6e] mb-3">{v.titulo}</h3>
...
function ServiciosSection() {
  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-[#0c4a6e] mb-3">Nuestros Servicios</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {servicios.map((s) => (
            <Link
              key={s.titulo}
              href={s.href}
              className="group bg-[#f0f9ff] border border-sky-100 rounded-xl p-6 hover:border-[#0ea5e9] hover:bg-white hover:shadow-md transition-all"
            >
              <div className="w-10 h-10 rounded-lg bg-[#0c4a6e] flex items-center justify-center mb-4">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <ellipse cx="9" cy="9" rx="7.5" ry="5" stroke="white" strokeWidth="1.5" />
                  <circle cx="9" cy="9" r="2.5" fill="white" />
                </svg>
              </div>
              <h3 className="font-bold text-[#0c4a6e] mb-2 group-hover:text-[#0ea5e9] transition-colors">{s.titulo}</h3>
        ...
        <div className="text-center mt-8">
          <Link
            href="/servicios"
            className="inline-block bg-[#0c4a6e] text-white px-7 py-3 rounded-full font-semibold hover:bg-[#082f49] transition-colors"
          >
  ...
  return (
    <section className="py-16 bg-[#f0f9ff]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-[#0c4a6e] mb-3">¿No sabe qué lente necesita?</h2>
          <div className="w-16 h-1 bg-[#0ea5e9] mx-auto rounded-full mb-4" />
...
function SolicitarCitaSection() {
  return (
    <section className="py-16 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-[#0c4a6e] mb-3">Solicitar Cita</h2>
          <div className="w-16 h-1 bg-[#0ea5e9] mx-auto rounded-full mb-4" />
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div className="space-y-6">
            ...
            <div className="bg-[#f0f9ff] rounded-2xl p-6 border border-sky-100 space-y-4">
              <p className="font-semibold text-[#0c4a6e]">Información de contacto</p>
              <div className="space-y-3 text-sm">
                <div className="flex items-center gap-3 text-slate-600">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0ea5e9" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                  Torre Médica Ciudad del Río, Medellín
                </div>
                <div className="flex items-center gap-3 text-slate-600">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0ea5e9" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                  Lunes a viernes: 7:30 am – 5:30 pm
                </div>
                <div className="flex items-center gap-3 text-slate-600">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0ea5e9" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
          ...
          <form className="space-y-4" action="https://wa.me/573113154316" method="GET">
            <div>
              ...
              <input
                ...
                required
                maxLength={100}
                className="w-full px-4 py-3 rounded-xl border border-slate-200 text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#0ea5e9] focus:border-transparent transition-all"
            ...
            <div>
              ...
              <select className="w-full px-4 py-3 rounded-xl border border-slate-200 text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#0ea5e9] focus:border-transparent transition-all">
            ...
            <button
              type="submit"
              className="w-full bg-[#0c4a6e] text-white py-3.5 rounded-xl font-semibold hover:bg-[#082f49] transition-colors"
            >
              Enviar solicitud
            </button>
