    ...
    <>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16 grid md:grid-cols-2 gap-12">
        <div className="space-y-8">
          <div>
            <h2 className="text-2xl font-bold text-[#1e3a8a] mb-6">Información de contacto</h2>

            <div className="space-y-5">
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#1e3a8a] flex items-center justify-center shrink-0 text-white">
                ...
                <div>
                  <p className="font-semibold text-[#1e3a8a]">WhatsApp — Aria</p>
                  <a
                    href="https://wa.me/573113154316"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#4a80e4] hover:underline"
                  >
                    +57 311 315 4316
                  </a>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-[#1e3a8a]">Correo electrónico</p>
                  <a href="mailto:info@lentesespecializados.com" className="text-[#4a80e4] hover:underline">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-semibold text-[#1e3a8a]">Ubicación</p>
          ...
          <div>
            <h3 className="font-bold text-[#1e3a8a] mb-4">Horario de atención</h3>
          ...
          <div className="bg-[#f0f9ff] rounded-2xl p-5 border border-sky-100">
            <p className="font-semibold text-[#1e3a8a] mb-1">Aria está disponible 24/7</p>
        ...
        <div>
          <h2 className="text-2xl font-bold text-[#1e3a8a] mb-6">Envíenos un mensaje</h2>
          <form className="space-y-4" action="mailto:info@lentesespecializados.com" method="GET">
            ...
            <div>
              ...
              <textarea
                ...
                name="mensaje"
                rows={4}
                className="w-full px-4 py-3 rounded-xl border border-slate-200 text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#4a80e4] focus:border-transparent transition-all resize-none"
